    ...
    return (
      <div className="flex p-5 justify-between">
        ...
        <div className="flex mt-2 ml-10">
          <div class="w-32 px-10 flex justify-center font-semibold border-2 border-black bg-blue-400 h-7">
            Home
          </div>
          <div className="w-32 flex justify-center font-semibold border-2 border-black h-7">
            About Us
          </div>
          <div class="w-32 flex justify-center border-2 font-semibold border-black h-7">
            Contact Us
          </div>
